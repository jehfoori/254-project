...
`define VX_CSR_TEAM_TENSOR_A_OFFSET     12'hFD4
`define VX_CSR_TEAM_TENSOR_B_OFFSET     12'hFD5
`define VX_CSR_TEAM_TENSOR_C_ADDR       12'hFD6
`define VX_CSR_TEAM_TENSOR_C_STRIDE     12'hFD7
`define VX_CSR_TEAM_TENSOR_A_STRIDE     12'hFD8
`define VX_CSR_TEAM_TENSOR_B_STRIDE     12'hFD9
`define VX_CSR_TEAM_TENSOR_K_TILES      12'hFDA
`define VX_CSR_TEAM_TENSOR_RUN          12'hFDB
`define VX_CSR_TEAM_TENSOR_STATUS_SEL   12'hFDC
`define VX_CSR_TEAM_TENSOR_STATUS       12'hFDD
`define VX_CSR_TEAM_TENSOR_A_SEED       12'hFDE
`define VX_CSR_TEAM_TENSOR_B_SEED       12'hFDF
`define VX_CSR_TEAM_TENSOR_A_WORD0      12'hFE0
`define VX_CSR_TEAM_TENSOR_A_WORD1      12'hFE1
`define VX_CSR_TEAM_TENSOR_B_WORD0      12'hFE2
`define VX_CSR_TEAM_TENSOR_B_WORD1      12'hFE3
